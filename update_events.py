...
Sources: 36 total covering all major OKC venues, districts, and categories.
"""
...
SOURCES = {
    ...
    'coffee_cars': {
        ...
        'system': (
            ...
            'at 600 N. Robinson Ave #500, Oklahoma City (in the Citizen Building). '
            'Check vergeokc.com/news-events for upcoming events. '
            'Key recurring events to always include: '
            '1 Million Cups — every Wednesday 9-10 AM (free entrepreneur networking, open to all); '
            'Pitches, Pizza & Pints — 4th Wednesday of each month, evening (free pitch night, open to public); '
            'OTV Workshops — 1st Wednesday of each month 4-6 PM (free business workshops). '
            'Also look for any special speaker events, demo days, accelerator events, or '
            'community-facing programming announced on their website or social media. '
